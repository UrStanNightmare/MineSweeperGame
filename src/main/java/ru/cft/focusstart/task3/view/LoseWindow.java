...
import ru.cft.focusstart.task3.controller.MinesweeperGameController;
...
public class LoseWindow extends JDialog {
    private final static Logger log = LoggerFactory.getLogger(LoseWindow.class.getName());

    private ActionListener newGameListener;
    private ActionListener exitListener;

    public LoseWindow(JFrame owner) {
        super(owner, "Lose", false);
    ...
    private JLabel createLoseLabel(GridBagLayout layout) {
        String loseMessage = "You've lost! Try again or surrender!";
        JLabel label = new JLabel(loseMessage);
